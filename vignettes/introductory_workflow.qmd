...
title: Introductory
vignette: >
    %\VignetteIndexEntry{Introductory}
...
::: {#translate style="display: flex; gap: 1em; align-items: center;"}

<a href="introductory_workflow_french_version.qmd" style="display: flex; align-items: center; gap: 0.5em;">
  <img src="figures/flags/France_flag.png" alt="French flag" style="width: 30px; height: auto;"/> <strong>French</strong>
</a>

<a href="introductory_workflow_dutch_version.qmd" style="display: flex; align-items: center; gap: 0.5em;">
  <img src="figures/flags/Netherland_flag.jpg" alt="Netherland flag" style="width: 30px; height: auto;"/> <strong>Dutch</strong>
</a>
...
`TreeSummarizedExperiment` (`TreeSE`) from scratch from basic text files. For
more information, see
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/import.html).

For this demonstration, you can either use your own data or one of the
built-in datasets provided by mia, which you can find
[here](https://microbiome.github.io/OMA/docs/devel/pages/import.html#sec-package-data).
...
and other data containers, see
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/containers.html).
...
[here](https://microbiome.github.io/OMA/docs/devel/pages/subsetting.html).
...
the diagnoses of the patients from whom the samples were drawn.
...
analysis and reveal broader patterns. By grouping taxonomic features at a chosen
level, such as Phylum, you can better understand general trends and
distributions. The `agglomerateByRank()` function streamlines this process,
making it easier to analyze and visualize data at a higher level of aggregation.
...
abundances. See
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/composition.html) for
more details on composition
summaries. This approach visualizes the relative abundances of selected
taxonomic features
...
Community diversity measures in microbiology can be categorized into three groups:
    ...
    - Diversity: A combination of taxonomic feature richness and equitability.

Diversity can vary in association with different phenotypes.
Next, we will calculate Faith's phylogenetic diversity index. What sets this
index apart is its incorporation of phylogeny into the diversity calculation.
This index considers both the number and the relatedness of different
taxonomic features, using
branch lengths on a phylogenetic tree. For
more information on diversity, see
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/alpha_diversity.html).
...
refer to
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/beta_diversity.html).

In this analysis, we use UniFrac dissimilarity, which takes into account
the phylogenetic relationships among features. UniFrac measures the phylogenetic
...
(see [OMA](https://microbiome.github.io/OMA/docs/devel/pages/differential_abundance.html)).
