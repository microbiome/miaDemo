---
title: Introductory (Dutch)
format:
  html:
    html-math-method: katex
vignette: >
    %\VignetteIndexEntry{Introductory (Dutch)}
...
het
[OMA boek](https://microbiome.github.io/OMA/docs/devel/pages/import.html#sec-package-data).
...
van zowel **je eigen data**(
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/import.html)) of door
een bestaand
...
Een **assay** (
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/containers.html)) is
een methode om de aanwezigheid en
...
`rowData` bevat gegevens van een type microbe,
...
kunnen wel gebruik maken van Bioconductor's `scater` pakket en het `vegan`
pakket, dat @R_vegan hier kan worden gevonden om de ongelijkheid om te zetten in
