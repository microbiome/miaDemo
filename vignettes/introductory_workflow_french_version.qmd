...
vignette: >
    %\VignetteIndexEntry{Introductory (French)}
...
<a href="introductory_workflow.qmd" style="display: flex; align-items: center; gap: 0.5em;">
  <img src="figures/flags/GB_flag.png" alt="Great Britain flag" style="width: 30px; height: auto;"/> <strong>English</strong>
</a>
...
<div id="translate">
  <a href="introductory_workflow.Rmd"><img src="figures/flags/GB_flag.png" alt="Great Britain flag" class="flag"/> **English** </a>
  <a href="introductory_workflow_dutch_version.Rmd"><img src="figures/flags/Netherland_flag.jpg" alt="Netherland flag" class="flag"/> **Dutch** </a>
</div>
...
de données intégrés fournis par mia que vous trouverez ici
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/import.html#sec-package-data):
...
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/import.html)) ou
convertir un
objet existant en un objet `TreeSummarizedExperiment` comme indiqué
dans **cette section** :
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/convert.html).
...
Vous pouvez accéder aux assays  **assays** (
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/containers.html)) de
cette manière :
...
Alors que `colData` est accessible via :
...
**rowData** contient des données sur les caractéristiques
...
les valeurs projetées étant appelées coordonnées principales.
...
à **cette section**
[OMA](https://microbiome.github.io/OMA/docs/devel/pages/cross_correlation.html).
