...
session will follow a demo from the
...
which is designed for microbiome data science. The _mia_ package provides essential tools for analyzing microbiome data using the SummarizedExperiment framework.
...
- **Understand miaverse**: Explore the _miaverse_ framework and its integration with the _SummarizedExperiment_ framework.

- **Use _TreeSE_**: Learn to utilize the _TreeSummarizedExperiment_ class for effective microbiome data analysis.

- **Access resources**: Get familiar with additional tools and resources, including the OMA online book.

#### Learning objectives

- **Analyze and apply methods**:  Apply the _miaverse_ framework to process and analyze microbiome data.

- **Create visualizations**: Generate and interpret visualizations of microbiome data using _miaverse_.

- **Explore documentation**: Navigate the OMA online book to discover additional tools and methods.

## Workshop

### 1 Background

The _SummarizedExperiment_ (_SE_) is a versatile data container in Bioconductor,
widely used across diverse fields. It promotes synergy through shared methods
...
1. Set up your local computer or access an [an online environment](https://workshop.bioconductor.org/).
